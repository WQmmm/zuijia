...
<div class="order cart mt"><!-----------------site------------------->
    ...
    <div class="orderCon wrapper clearfix">
        <div class="orderL fl"><!--------h3----------------><h3>收件信息<a href="#" class="fr">新增地址</a></h3>
            ...
            <h3>支付方式</h3><!--------way---------------->
            <div class="way clearfix"><img class="on" src="/static/img/temp/way01.jpg"><img src="/static/img/temp/way02.jpg"><img
                    src="/static/img/temp/way03.jpg"><img src="/static/img/temp/way04.jpg"></div>
            <h3>选择快递</h3><!--------dis---------------->
        ...
        <div class="orderR fr">
            <div class="msg"><h3>订单内容<a href="cart.html" class="fr">返回购物车</a></h3><!--------ul---------------->
                ...
                <ul class="clearfix">
                    <li class="fl"><img src="/static/img/temp/order02.jpg"></li>
                    <li class="fl"><p>创意现代简约干花花瓶摆件</p>
                        <p>颜色分类：烟灰色玻璃瓶</p>
                        <p>数量：1</p></li>
                    <li class="fr">￥69.90</li>
            ...
            <!--<input type="button" name="" value="去支付">--> <a href="/indexController/toOk"
                                                                class="pay">去支付</a></div>
    </div>
</div><!--编辑弹框--><!--遮罩-->
<div class="mask"></div>
