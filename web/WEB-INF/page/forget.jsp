...
<div class="order cart"><!-----------------logo------------------->
    <div class="logo"><h1 class="wrapper clearfix"><a href="index.html"><img class="fl" src="/static/img/temp/logo.png"></a>
    </h1></div>
    <div class="forCon"><p>安全设置-找回密码</p>
        ...
        <div class="formCon"><!--步骤1-->
            <form action="#" method="post" class="one"><input type="text" value=""
                    ...
                    src="/static/img/temp/code.jpg"><br><input type="button" value="下一步" class="next"></form><!--步骤2-->
